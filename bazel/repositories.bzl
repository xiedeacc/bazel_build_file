...
def deps():
    http_archive(
        ...
        build_file = "@bazel_build_file_repo//bazel:gcc_arm_armv7_none_musleabi.BUILD",
        ...
        urls = [
            ...
            "https://media.githubusercontent.com/media/xiedeacc/bazel_build_file_repo/master/toolchains/toolchains/arm_cortex-a9_gcc-8.4.0_musl.tar.gz",
        ],
    )
    ################################################################################################
    ...
    http_archive(
        ...
        build_file = "@bazel_build_file_repo//bazel:gcc_arm_aarch64_none_elf.BUILD",
    ...
    http_archive(
        ...
        build_file = "@bazel_build_file_repo//bazel:gcc_arm_aarch64_none_gnueabi.BUILD",
    ...
    http_archive(
        ...
        build_file = "@bazel_build_file_repo//bazel:gcc_arm_armv7_none_eabi.BUILD",
    ...
    http_archive(
        ...
        build_file = "@bazel_build_file_repo//bazel:gcc_arm_armv7_none_gnueabihf.BUILD",
    ...
    http_archive(
        ...
        build_file = "@bazel_build_file_repo//bazel:gcc_arm_aarch64_none_musleabi.BUILD",
        ...
        urls = [
            ...
            "https://media.githubusercontent.com/media/xiedeacc/bazel_build_file_repo/master/toolchains/toolchains/aarch64_generic_gcc-11.2.0_musl.tar.gz",
        ],
    )
    ################################################################################################
    ...
    http_archive(
        ...
        urls = [
            ...
            "https://media.githubusercontent.com/media/xiedeacc/bazel_build_file_repo/master/toolchains/toolchains/arm_generic_gcc-11.2.0_musl.tar.gz",
        ],
    )
